if Code.ensure_loaded?(Firebirdex) do
  defmodule Ecto.Adapters.Firebird.Connection do
    ...
    defp ecto_cast_to_db(:utc_datetime_usec, _query), do: "timestamp"
    defp ecto_cast_to_db(:naive_datetime_usec, _query), do: "timestamp"
    ...
    defp ecto_to_db(:serial, _query),              do: "integer generated by default as identity"
    defp ecto_to_db(:bigserial, _query),           do: "bigint generated by default as identity"
    defp ecto_to_db(:binary_id, _query),           do: "varchar(32)"
    defp ecto_to_db(:string, _query),              do: "varchar"
    defp ecto_to_db(:text, _query),                do: "blob sub_type 1"
    defp ecto_to_db(:float, _query),               do: "double precision"
    defp ecto_to_db(:binary, _query),              do: "blob sub_type 0"
    defp ecto_to_db(:uuid, _query),                do: "varchar(32)"
    defp ecto_to_db(:map, _query),                 do: "blob sub_type 1"
    defp ecto_to_db({:map, _}, _query),            do: "blob sub_type 1"
    defp ecto_to_db(:time_usec, _query),           do: "time"
    defp ecto_to_db(:utc_datetime, _query),        do: "timestamp"
    defp ecto_to_db(:utc_datetime_usec, _query),   do: "timestamp"
    defp ecto_to_db(:naive_datetime, _query),      do: "timestamp"
    defp ecto_to_db(:naive_datetime_usec, _query), do: "timestamp"
